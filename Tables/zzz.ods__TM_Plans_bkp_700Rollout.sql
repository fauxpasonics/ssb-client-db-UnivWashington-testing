CREATE TABLE [zzz].[ods__TM_Plans_bkp_700Rollout]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Insert__3BFFE745] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Update__3CF40B7E] DEFAULT (getdate()),
...
GO
ALTER TABLE [zzz].[ods__TM_Plans_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Plans__3213E83F36B84F64] PRIMARY KEY CLUSTERED  ([id]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IDX_PlanKey] ON [zzz].[ods__TM_Plans_bkp_700Rollout] ([acct_id], [plan_event_id], [ticket_status], [section_id], [row_id], [seat_num]) INCLUDE ([num_seats], [ssbPriceCode])
GO
CREATE NONCLUSTERED INDEX [IDX_ticket_status] ON [zzz].[ods__TM_Plans_bkp_700Rollout] ([ticket_status])
GO
CREATE NONCLUSTERED INDEX [IDX_UpdateDate] ON [zzz].[ods__TM_Plans_bkp_700Rollout] ([UpdateDate])
GO
