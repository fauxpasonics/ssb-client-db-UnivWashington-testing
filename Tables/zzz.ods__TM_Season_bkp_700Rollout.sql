...
[org_id] [int] NULL,
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Season__Inser__41B8C09B] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Season__Updat__42ACE4D4] DEFAULT (getdate()),
