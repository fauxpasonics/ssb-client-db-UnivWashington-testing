...
[season_id] [int] NULL,
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Events__Inser__2645B050] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Events__Updat__2739D489] DEFAULT (getdate()),
