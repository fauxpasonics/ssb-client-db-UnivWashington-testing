CREATE TABLE [dbo].[DimPlanType_V2]
(
...
GO
ALTER TABLE [dbo].[DimPlanType_V2] ADD CONSTRAINT [PK_dbo__DimPlanType_V2] PRIMARY KEY CLUSTERED  ([DimPlanTypeId])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__IsDeleted] ON [dbo].[DimPlanType_V2] ([ETL__IsDeleted])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__SourceSystem] ON [dbo].[DimPlanType_V2] ([ETL__SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__UpdatedDate] ON [dbo].[DimPlanType_V2] ([ETL__UpdatedDate] DESC)
GO
CREATE NONCLUSTERED INDEX [IX_PlanTypeCode] ON [dbo].[DimPlanType_V2] ([PlanTypeCode])
GO
