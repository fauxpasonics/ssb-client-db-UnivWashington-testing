...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimEventH__Creat__51300E55] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimEventH__Updat__5224328E] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimEventH__IsDel__531856C7] DEFAULT ((0)),
