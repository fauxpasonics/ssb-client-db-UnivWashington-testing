CREATE TABLE [zzz].[archive__TM_Tex_bkp_700Rollout]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__CreatedD__2180FB33] DEFAULT (getdate())
)
WITH
(
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Tex_bkp_700Rollout] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Tex_bkp_700Rollout] ([SourceFileName])
GO
