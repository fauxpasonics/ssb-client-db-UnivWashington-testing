CREATE TABLE [zzz].[ods__TM_PriceCode_bkp_700Rollout]
(
...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Inser__3DE82FB7] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Updat__3EDC53F0] DEFAULT (getdate()),
...
GO
ALTER TABLE [zzz].[ods__TM_PriceCode_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Price__3213E83F7359875C] PRIMARY KEY CLUSTERED  ([id]) WITH (DATA_COMPRESSION = PAGE)
GO
