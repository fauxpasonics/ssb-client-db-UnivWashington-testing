CREATE TABLE [zzz].[archive__TM_HeldSeats_bkp_700Rollout]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Creat__17F790F9] DEFAULT (getdate())
)
WITH
(
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_HeldSeats_bkp_700Rollout] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_HeldSeats_bkp_700Rollout] ([SourceFileName])
GO
