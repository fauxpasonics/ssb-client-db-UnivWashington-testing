CREATE TABLE [dbo].[DimPriceType_V2]
(
...
GO
ALTER TABLE [dbo].[DimPriceType_V2] ADD CONSTRAINT [PK__DimPrice__1214958B93AF8AB7] PRIMARY KEY CLUSTERED  ([DimPriceTypeId])
GO
CREATE NONCLUSTERED INDEX [IDX_ETL__IsDeleted] ON [dbo].[DimPriceType_V2] ([ETL__IsDeleted])
GO
CREATE NONCLUSTERED INDEX [IDX_ETL__SourceSystem] ON [dbo].[DimPriceType_V2] ([ETL__SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IDX_KeyPAC] ON [dbo].[DimPriceType_V2] ([ETL__SSID_PAC_SEASON], [ETL__SSID_PAC_PRTYPE])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__UpdatedDate] ON [dbo].[DimPriceType_V2] ([ETL__UpdatedDate] DESC)
GO
CREATE NONCLUSTERED INDEX [IX_PriceTypeCode] ON [dbo].[DimPriceType_V2] ([PriceTypeCode])
GO
