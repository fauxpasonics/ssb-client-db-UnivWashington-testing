CREATE TABLE [dev].[FactTicketSalesTM]
(
[id] [bigint] NOT NULL,
...
[ssbIsHost] [bit] NULL,
[ssbPriceCode] [nvarchar] (4000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
CREATE NONCLUSTERED INDEX [IDX_acct_id] ON [dev].[FactTicketSalesTM] ([acct_id])
GO
CREATE NONCLUSTERED INDEX [IDX_acct_Rep_id] ON [dev].[FactTicketSalesTM] ([acct_Rep_id], [orig_acct_rep_id])
GO
CREATE NONCLUSTERED INDEX [IDX_event_id] ON [dev].[FactTicketSalesTM] ([event_id])
GO
CREATE NONCLUSTERED INDEX [IDX_ledger_id] ON [dev].[FactTicketSalesTM] ([ledger_id])
GO
CREATE NONCLUSTERED INDEX [IDX_plan_event_id] ON [dev].[FactTicketSalesTM] ([plan_event_id])
GO
CREATE NONCLUSTERED INDEX [IDX_price_code] ON [dev].[FactTicketSalesTM] ([price_code])
GO
CREATE NONCLUSTERED INDEX [IDX_promo_code] ON [dev].[FactTicketSalesTM] ([promo_code])
GO
CREATE NONCLUSTERED INDEX [IDX_srs] ON [dev].[FactTicketSalesTM] ([section_id], [row_id], [seat_num])
GO
CREATE NONCLUSTERED INDEX [IDX_sell_location] ON [dev].[FactTicketSalesTM] ([sell_location])
GO
CREATE NONCLUSTERED INDEX [IDX_ssbIsHost] ON [dev].[FactTicketSalesTM] ([ssbIsHost])
GO
CREATE NONCLUSTERED INDEX [IDX_ssbPriceCode] ON [dev].[FactTicketSalesTM] ([ssbPriceCode])
GO
