...
GO
ALTER TABLE [dbo].[TK_ODET_EVENT_SBLS] ADD CONSTRAINT [PK_TK_ODET_EVENT_SBLS] PRIMARY KEY CLUSTERED  ([ETLSID], [SEASON], [CUSTOMER], [SEQ], [VMC], [SVMC])
GO
CREATE NONCLUSTERED INDEX [IDX_CUSTOMER] ON [dbo].[TK_ODET_EVENT_SBLS] ([CUSTOMER])
GO
CREATE NONCLUSTERED INDEX [IDX_SEASON] ON [dbo].[TK_ODET_EVENT_SBLS] ([SEASON])
GO
CREATE NONCLUSTERED INDEX [IDX_ZID] ON [dbo].[TK_ODET_EVENT_SBLS] ([ZID])
GO
