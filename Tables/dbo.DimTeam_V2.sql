...
GO
ALTER TABLE [dbo].[DimTeam_V2] ADD CONSTRAINT [PK_dbo__DimTeam_V2] PRIMARY KEY CLUSTERED  ([DimTeamId])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__IsDeleted] ON [dbo].[DimTeam_V2] ([ETL__IsDeleted])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__SourceSystem] ON [dbo].[DimTeam_V2] ([ETL__SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__UpdatedDate] ON [dbo].[DimTeam_V2] ([ETL__UpdatedDate] DESC)
GO
