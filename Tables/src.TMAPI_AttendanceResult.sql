...
[ETL_CreatedDate] [datetime] NULL CONSTRAINT [DF__TMAPI_Att__ETL_C__28ED12D1] DEFAULT (getdate()),
...
GO
ALTER TABLE [src].[TMAPI_AttendanceResult] ADD CONSTRAINT [PK__TMAPI_At__7EF6BFCDE944045D] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
