...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__InsertDa__4959E263] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__UpdateDa__4A4E069C] DEFAULT (getdate()),
