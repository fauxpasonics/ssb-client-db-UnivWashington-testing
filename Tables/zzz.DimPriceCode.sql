...
GO
ALTER TABLE [zzz].[DimPriceCode] ADD CONSTRAINT [PK_DimPriceCode_1] PRIMARY KEY CLUSTERED  ([DimPriceCodeId])
GO
CREATE NONCLUSTERED INDEX [IDX_PC1] ON [zzz].[DimPriceCode] ([PC1])
GO
CREATE NONCLUSTERED INDEX [IDX_PC2] ON [zzz].[DimPriceCode] ([PC2])
GO
CREATE NONCLUSTERED INDEX [IDX_PC3] ON [zzz].[DimPriceCode] ([PC3])
GO
CREATE NONCLUSTERED INDEX [IDX_PC4] ON [zzz].[DimPriceCode] ([PC4])
GO
CREATE NONCLUSTERED INDEX [IDX_PriceCode] ON [zzz].[DimPriceCode] ([PriceCode])
GO
CREATE NONCLUSTERED INDEX [IDX_PriceCodeGroup] ON [zzz].[DimPriceCode] ([PriceCodeGroup])
GO
CREATE NONCLUSTERED INDEX [IDX_SSID_price_code] ON [zzz].[DimPriceCode] ([SSID_price_code])
GO
