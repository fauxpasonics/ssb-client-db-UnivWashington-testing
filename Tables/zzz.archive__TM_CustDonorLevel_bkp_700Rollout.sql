CREATE TABLE [zzz].[archive__TM_CustDonorLevel_bkp_700Rollout]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_archive__TM_CustDonorLevel] ON [zzz].[archive__TM_CustDonorLevel_bkp_700Rollout]
GO
