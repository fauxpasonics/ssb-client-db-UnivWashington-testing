CREATE TABLE [zzz].[archive__TM_CustEmail_bkp_700Rollout]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_archive__TM_CustEmail] ON [zzz].[archive__TM_CustEmail_bkp_700Rollout]
GO
