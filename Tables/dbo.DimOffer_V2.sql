...
[ETL__SSID_VTX_id] [decimal] (20, 0) NULL,
...
GO
ALTER TABLE [dbo].[DimOffer_V2] ADD CONSTRAINT [PK__DimOffer__398C508D7AB09818] PRIMARY KEY CLUSTERED  ([DimOfferId])
GO
CREATE NONCLUSTERED INDEX [IDX_ETL__IsDeleted] ON [dbo].[DimOffer_V2] ([ETL__IsDeleted])
GO
CREATE NONCLUSTERED INDEX [IDX_ETL__SourceSystem] ON [dbo].[DimOffer_V2] ([ETL__SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__UpdatedDate] ON [dbo].[DimOffer_V2] ([ETL__UpdatedDate] DESC)
GO
CREATE NONCLUSTERED INDEX [IX_OfferCode] ON [dbo].[DimOffer_V2] ([OfferCode])
GO
