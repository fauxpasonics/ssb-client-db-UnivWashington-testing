...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimArena__Create__41B8C09B] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimArena__Update__42ACE4D4] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimArena__IsDele__43A1090D] DEFAULT ((0)),
[DeleteDate] [datetime] NULL
)
GO
ALTER TABLE [zzz].[DimArena] ADD CONSTRAINT [PK_DimArena] PRIMARY KEY CLUSTERED  ([DimArenaId])
GO
CREATE UNIQUE NONCLUSTERED INDEX [IDX_LoadKey] ON [zzz].[DimArena] ([SourceSystem], [SSID_arena_id])
GO
