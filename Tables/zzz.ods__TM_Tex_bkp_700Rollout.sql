...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__InsertDa__477199F1] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__UpdateDa__4865BE2A] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [IX_TM_Tex_activity_add_datetime] ON [zzz].[ods__TM_Tex_bkp_700Rollout] ([activity], [add_datetime]) INCLUDE ([assoc_acct_id], [event_id], [num_seats], [row_id], [seat_num], [section_id], [te_buyer_fees_hidden], [te_purchase_price]) WITH (DATA_COMPRESSION = PAGE)
GO
