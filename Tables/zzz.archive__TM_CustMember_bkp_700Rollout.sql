CREATE TABLE [zzz].[archive__TM_CustMember_bkp_700Rollout]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_archive__TM_CustMember] ON [zzz].[archive__TM_CustMember_bkp_700Rollout]
GO
