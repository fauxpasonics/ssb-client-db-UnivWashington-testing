...
GO
CREATE NONCLUSTERED INDEX [FactTicketSales_CustomerId] ON [dbo].[FactTicketSales] ([DimCustomerId]) INCLUDE ([BlockPurchasePrice], [DimCustomerIdSalesRep], [DimDateId], [DimEventId], [DimItemId], [DimPriceCodeId], [DimSeasonId], [DimSeatIdStart], [DimTicketTypeId], [OwedAmount], [PaidAmount], [QtySeat])
GO
