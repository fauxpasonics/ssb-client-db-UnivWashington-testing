...
GO
GRANT DELETE ON  [mdm].[MatchkeyConfig] TO [db_SSB_IE_Permitted]
GO
GRANT INSERT ON  [mdm].[MatchkeyConfig] TO [db_SSB_IE_Permitted]
GO
GRANT UPDATE ON  [mdm].[MatchkeyConfig] TO [db_SSB_IE_Permitted]
GO
