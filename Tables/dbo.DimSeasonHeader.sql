...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Creat__65370702] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Updat__662B2B3B] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimSeason__IsDel__671F4F74] DEFAULT ((0)),
