...
GO
ALTER TABLE [etl].[EventLog] ADD CONSTRAINT [PK__EventLog__5E548648815B2B3C] PRIMARY KEY CLUSTERED  ([LogId])
GO
CREATE NONCLUSTERED INDEX [IDX_EventDate] ON [etl].[EventLog] ([EventDate])
GO
