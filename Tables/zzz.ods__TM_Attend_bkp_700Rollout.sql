...
GO
CREATE NONCLUSTERED INDEX [IX_TM_Attend_event_id_section_id_row_id_seat_num] ON [zzz].[ods__TM_Attend_bkp_700Rollout] ([event_id], [section_id], [row_id], [seat_num]) INCLUDE ([HashKey], [id], [InsertDate]) WITH (DATA_COMPRESSION = PAGE)
GO
CREATE NONCLUSTERED INDEX [IX_TM_Attend_UpdateDate] ON [zzz].[ods__TM_Attend_bkp_700Rollout] ([UpdateDate]) WITH (DATA_COMPRESSION = ROW)
GO
