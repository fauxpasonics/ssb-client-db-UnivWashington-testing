CREATE TABLE [dbo].[DimTicketClass_V2]
(
...
GO
ALTER TABLE [dbo].[DimTicketClass_V2] ADD CONSTRAINT [PK_dbo__DimTicketClass_V2] PRIMARY KEY CLUSTERED  ([DimTicketClassId])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__IsDeleted] ON [dbo].[DimTicketClass_V2] ([ETL__IsDeleted])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__SourceSystem] ON [dbo].[DimTicketClass_V2] ([ETL__SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__UpdatedDate] ON [dbo].[DimTicketClass_V2] ([ETL__UpdatedDate] DESC)
GO
CREATE NONCLUSTERED INDEX [IX_TicketClassCode] ON [dbo].[DimTicketClass_V2] ([TicketClassCode])
GO
