...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Creat__4B422AD5] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Updat__4C364F0E] DEFAULT (getdate()),
[IsDeleted] [bit] NULL CONSTRAINT [DF__DimSeason__IsDel__4D2A7347] DEFAULT ((0)),
...
GO
ALTER TABLE [zzz].[DimSeason] ADD CONSTRAINT [PK_DimSeason] PRIMARY KEY CLUSTERED  ([DimSeasonId])
GO
CREATE UNIQUE NONCLUSTERED INDEX [IDX_LoadKey] ON [zzz].[DimSeason] ([SourceSystem], [SSID_season_id])
GO
