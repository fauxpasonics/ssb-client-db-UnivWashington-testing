CREATE TABLE [dbo].[DimTicketType_V2]
(
...
GO
ALTER TABLE [dbo].[DimTicketType_V2] ADD CONSTRAINT [PK_dbo__DimTicketType_V2] PRIMARY KEY CLUSTERED  ([DimTicketTypeId])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__IsDeleted] ON [dbo].[DimTicketType_V2] ([ETL__IsDeleted])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__SourceSystem] ON [dbo].[DimTicketType_V2] ([ETL__SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__UpdatedDate] ON [dbo].[DimTicketType_V2] ([ETL__UpdatedDate] DESC)
GO
CREATE NONCLUSTERED INDEX [IX_TicketTypeCode] ON [dbo].[DimTicketType_V2] ([TicketTypeCode])
GO
