...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Inser__4589517F] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Updat__467D75B8] DEFAULT (getdate()),
