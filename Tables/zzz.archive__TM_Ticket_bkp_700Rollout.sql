CREATE TABLE [zzz].[archive__TM_Ticket_bkp_700Rollout]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Ticket__Creat__5D60DB10] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Ticket_bkp_700Rollout] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Ticket_bkp_700Rollout] ([SourceFileName])
GO
