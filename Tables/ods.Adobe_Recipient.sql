...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Adobe_Rec__ETL_C__05C96186] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Adobe_Rec__ETL_U__06BD85BF] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Adobe_Rec__ETL_I__07B1A9F8] DEFAULT ((0)),
