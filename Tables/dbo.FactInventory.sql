...
GO
CREATE NONCLUSTERED INDEX [IDX_IsSold] ON [dbo].[FactInventory] ([IsSold])
GO
...
GO
CREATE NONCLUSTERED INDEX [IDX_FactoryInverntory_PostedDimPriceCodeId] ON [dbo].[FactInventory] ([PostedDimPriceCodeId])
GO
