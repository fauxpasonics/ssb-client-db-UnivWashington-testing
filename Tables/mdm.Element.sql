...
[Custom] [bit] NULL,
[IsDeleted] [bit] NULL,
[DateCreated] [date] NULL CONSTRAINT [DF__Element__DateCre__4B180DA3] DEFAULT (getdate()),
[DateUpdated] [date] NULL CONSTRAINT [DF__Element__DateUpd__4C0C31DC] DEFAULT (getdate())
)
GO
...
END 
GO
ALTER TABLE [mdm].[Element] ADD CONSTRAINT [UQ_Element1] UNIQUE NONCLUSTERED  ([Element], [ElementType], [Custom], [IsDeleted])
GO
