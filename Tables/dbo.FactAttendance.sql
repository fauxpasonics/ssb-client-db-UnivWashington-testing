...
GO
ALTER TABLE [dbo].[FactAttendance] ADD CONSTRAINT [PK__FactAtte__5A5CE7B28A2B4454] PRIMARY KEY CLUSTERED  ([FactAttendanceId])
GO
...
GO
CREATE NONCLUSTERED INDEX [IX_FactAttendance_ETL_UpdatedDate] ON [dbo].[FactAttendance] ([ETL_UpdatedDate]) WITH (DATA_COMPRESSION = ROW)
GO
