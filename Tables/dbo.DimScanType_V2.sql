CREATE TABLE [dbo].[DimScanType_V2]
(
[DimScanTypeId] [int] NOT NULL IDENTITY(1, 1),
...
[ETL__SSID_TM_channel_ind] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ScanTypeCode] [nvarchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ScanTypeName] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ScanTypeDesc] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[ScanTypeClass] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[DimScanType_V2] ADD CONSTRAINT [PK__DimScanT__6465D62CEC85CCBE] PRIMARY KEY CLUSTERED  ([DimScanTypeId])
GO
CREATE NONCLUSTERED INDEX [IDX_ETL__IsDeleted] ON [dbo].[DimScanType_V2] ([ETL__IsDeleted])
GO
CREATE NONCLUSTERED INDEX [IDX_ETL__SourceSystem] ON [dbo].[DimScanType_V2] ([ETL__SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IDX_KeyTM] ON [dbo].[DimScanType_V2] ([ETL__SSID_TM_channel_ind])
GO
CREATE NONCLUSTERED INDEX [IX_ETL__UpdatedDate] ON [dbo].[DimScanType_V2] ([ETL__UpdatedDate] DESC)
GO
CREATE NONCLUSTERED INDEX [IX_ScanTypeCode] ON [dbo].[DimScanType_V2] ([ScanTypeCode])
GO
