CREATE TABLE [zzz].[archive__TM_AvailSeats_bkp_700Rollout]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Creat__1332DBDC] DEFAULT (getdate())
)
WITH
(
...
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_AvailSeats_bkp_700Rollout] ([SourceFileName])
GO
