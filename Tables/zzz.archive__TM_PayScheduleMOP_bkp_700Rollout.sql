CREATE TABLE [zzz].[archive__TM_PayScheduleMOP_bkp_700Rollout]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_archive__TM_PayScheduleMOP] ON [zzz].[archive__TM_PayScheduleMOP_bkp_700Rollout]
GO
