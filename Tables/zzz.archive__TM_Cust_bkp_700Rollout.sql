CREATE TABLE [zzz].[archive__TM_Cust_bkp_700Rollout]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Cust__Created__14270015] DEFAULT (getdate())
)
WITH
(
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Cust_bkp_700Rollout] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Cust_bkp_700Rollout] ([SourceFileName])
GO
