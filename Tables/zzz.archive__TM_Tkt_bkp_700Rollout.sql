CREATE TABLE [zzz].[archive__TM_Tkt_bkp_700Rollout]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__CreatedD__22751F6C] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Tkt_bkp_700Rollout] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Tkt_bkp_700Rollout] ([SourceFileName])
GO
